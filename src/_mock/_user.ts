...
export const _userList = Array.from({ length: 8 }, (_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
  ...
  avatarUrl: _mock.image.avatar(index),
  phoneNumber: _mock.phoneNumber(index),
  status: (index % 3 && 'banned') || 'active',
  operator_name: 'Dariya Cell',
  esim_type: ['single', 'multi', 'omni'][Math.floor(Math.random() * 3)],
  profiles:[
    {},
