...
export function CustomerTableRow({ row, selected, editHref, onSelectRow, onDeleteRow, detailsHref }: Props) {
  ...
  return (
    <>
      <TableRow hover selected={selected} aria-checked={selected} tabIndex={-1}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.esim_type}</TableCell>
